                ...
                <tr class='row'>                    
                    <td colspan="2">
                        <ul id="treeView" ej-tree-view="e-width:250px">
                            <li class="expanded"><span class="mailicon sprite-root"></span>Mail
                                <ul>
                                    <li><span class="mailicon sprite-inbox"></span>Inbox
                                        <ul>
                                            <li>
                                    ...
                                    <li><span class="mailicon sprite-drafts"></span>Drafts
                                        <ul>
                                            <li>
                                    ...
                                    <li><span class="mailicon sprite-sentitems"></span>Sent items
                                        <ul>
                                            <li>
                                    ...
                                    <li><span class="mailicon sprite-folders"></span>Personal
                                        <ul>
                                            <li>
                                                <span class="mailicon sprite-folder"></span>HR Team
                                            </li>
                            ...
                            <li class="expanded"><span class="mailicon sprite-calendar"></span>Calendar
                                <ul>
                                    <li>
                            ...
                            <li><span class="mailicon sprite-notes"></span>Notes
                                <ul>
                                    <li>
                            ...
                            <li><span class="mailicon sprite-contacts"></span>Contacts
                                <ul>
                                    <li>
