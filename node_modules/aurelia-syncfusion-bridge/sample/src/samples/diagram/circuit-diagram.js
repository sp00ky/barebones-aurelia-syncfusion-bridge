export class CircuitDiagram {
    constructor() {
      ...
      this.defaultSettings = {
        connector: {
          constraints: ej.datavisualization.Diagram.ConnectorConstraints.Default | ej.datavisualization.Diagram.ConnectorConstraints.Bridging, segments: [{ type: 'straight' }], targetDecorator: { shape: 'none' }, lineWidth: 2
        },
        node: { borderWidth: 2 }
      };
