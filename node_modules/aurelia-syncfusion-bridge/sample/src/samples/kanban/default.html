<template>
  ...
  <div>
     <ej-kanban id="Default" e-data-source.bind="defaultKanbanData" e-key-Field="Status" e-fields.bind="Field" e-card-settings.bind="CardSettings" e-allow-title="true" e-allow-selection="false" >       
