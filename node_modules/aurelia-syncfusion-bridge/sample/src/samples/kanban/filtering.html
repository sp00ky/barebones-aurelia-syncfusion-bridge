<template>
  ...
  <div>
     <ej-kanban id="Filtering" e-data-source.bind="filterKanbanData" e-key-Field="Status" e-fields.bind="Field" e-allow-searching="true" e-filter-settings.bind="Filter" >
