<template>
  ...
  <div>
     <ej-kanban id="Template" e-data-source.bind="tempKanbanData" e-key-Field="Status" e-fields.bind="Field" e-card-settings.bind="CardSettings" e-allow-title="true" e-tooltip-settings.bind="ToolTip" >
