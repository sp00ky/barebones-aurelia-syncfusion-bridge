<template>
  ...
  <div>
     <ej-kanban id="Swimlane" e-data-source.bind="swimlaneKanbanData" e-key-Field="Status" e-fields.bind="Field" e-card-settings.bind="CardSettings" e-allow-title="true" e-allow-selection="false" >
