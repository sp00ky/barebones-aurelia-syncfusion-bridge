...
<template>
  ...
  <div>
     <ej-kanban id="Contextmenu" e-data-source.bind="contextKanbanData" e-key-Field="Status" e-fields.bind="Field" e-edit-settings.bind="EditSettings" e-allow-title="true" e-context-menu-settings.bind="ContextMenu" >
