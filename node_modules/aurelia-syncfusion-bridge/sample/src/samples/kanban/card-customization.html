<template>
  ...
  <div>
     <ej-kanban  id="Customization" e-data-source.bind="custKanbanData" e-key-Field="Status" e-fields.bind="Field" e-card-settings.bind="CardSettings" e-allow-title="true">       
